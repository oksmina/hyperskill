class ComplexNumber:
    ...
    def __truediv__(self, other):
        r_other1 = other.real_part / (other.real_part * other.real_part + other.im_part * other.im_part)
        im_other2 = -other.im_part / (other.real_part * other.real_part + other.im_part * other.im_part)
        return self * ComplexNumber(r_other1, im_other2)